...
const translations: Record<Language, Record<string, string>> = {
  ...
  ar: {
    ...
    "Admin": "المشرف",
    "User": "مستخدم",
    "Search inventory, sales, reports...": "ابحث في المخزون والمبيعات والتقارير...",
    "Welcome back, {name}!": "مرحباً بعودتك، {name}!",
    "Here's what's happening with your business today.": "إليك ما يحدث في عملك اليوم.",
    ...
    "Based on sales velocity, you'll run out in 2 days. Order now to maintain stock.": "بناءً على سرعة المبيعات، سينفد المخزون خلال يومين. اطلب الآن للحفاظ على التوفر.",
    "Order Now": "اطلب الآن",
    "Wireless Earbuds are Hot!": "سماعات الأذن اللاسلكية رائجة!",
    "Sales up 45% this week. Consider increasing stock and promoting.": "المبيعات ارتفعت بنسبة 45٪ هذا الأسبوع. فكر في زيادة المخزون والترويج.",
    "View Details": "عرض التفاصيل",
    "Slow Moving: Laptop Sleeves": "بطيئة الحركة: حافظات اللابتوب",
    "Only 2 sold in 30 days. Consider price reduction or bundle deals.": "تم بيع قطعتين فقط خلال 30 يوماً. فكر في خفض السعر أو عروض الباقات.",
    ...
    "items": "عناصر",
    "available": "متاح",
    "Click on products to add them to the sale": "اضغط على المنتجات لإضافتها إلى عملية البيع",
    ...
    "revenue": "إيرادات",
    "Smart recommendations powered by your sales data": "توصيات ذكية مستندة إلى بيانات مبيعاتك",
    ...
    "No unread notifications at the moment.": "لا توجد إشعارات غير مقروءة حالياً.",
    ...
    "Manage your password and security options": "إدارة كلمة المرور وخيارات الأمان",
    "Current Password": "كلمة المرور الحالية",
    "New Password": "كلمة المرور الجديدة",
    "Confirm Password": "تأكيد كلمة المرور",
    "Update Password": "تحديث كلمة المرور",
    "Invite team members to help manage your store": "دعوة أعضاء الفريق للمساعدة في إدارة متجرك",
    ...
    "Only owners can invite staff. Contact your owner to get access.": "يمكن للمالكين فقط دعوة الموظفين. تواصل مع المالك للحصول على صلاحية.",
    "Active": "نشط",
    "Invited": "مدعو",
    "No staff members yet. Invite your first admin to get started.": "لا يوجد أعضاء فريق بعد. قم بدعوة أول مشرف للبدء.",
    ...
    "Based on current sales velocity of 8 units/day, you'll run out of USB-C Fast Chargers in approximately 2 days. Historical data shows stockouts result in 15% customer loss.": "استناداً إلى سرعة المبيعات الحالية البالغة 8 وحدات يومياً، سينفد مخزون شواحن USB-C السريعة خلال يومين تقريباً. تظهر البيانات أن نفاد المخزون يؤدي إلى خسارة 15٪ من العملاء.",
    "Potential revenue loss: ₦96,000/day": "خسارة الإيرادات المحتملة: ₦96,000 يومياً",
    "Order 50 units now": "اطلب 50 وحدة الآن",
    "Wireless Earbuds are Trending!": "سماعات الأذن اللاسلكية تشهد رواجاً!",
    "Sales of Wireless Earbuds Pro have increased by 45% this week compared to last week. This product is outperforming all other accessories.": "ارتفعت مبيعات سماعات الأذن اللاسلكية برو بنسبة 45٪ هذا الأسبوع مقارنة بالأسبوع الماضي. هذا المنتج يتفوق على بقية الإكسسوارات.",
    "Additional profit opportunity: ₦125,000/week": "فرصة ربح إضافية: ₦125,000 أسبوعياً",
    "Increase stock by 50%": "زيادة المخزون بنسبة 50٪",
    "Laptop Sleeve 15\" has only sold 2 units in the last 30 days. Current inventory of 22 units will take approximately 11 months to sell at this rate.": "لم يتم بيع سوى قطعتين من حافظة اللابتوب 15 بوصة خلال آخر 30 يوماً. المخزون الحالي البالغ 22 قطعة سيستغرق حوالي 11 شهراً للبيع بهذا المعدل.",
    ...
    "Samsung Galaxy A54 is selling faster than average. Market analysis suggests you can increase the price by ₦5,000 without affecting demand.": "هاتف سامسونج جالاكسي A54 يُباع أسرع من المتوسط. تشير تحليلات السوق إلى إمكانية زيادة السعر بمقدار ₦5,000 دون التأثير على الطلب.",
    ...
    "Based on customer purchase patterns, customers buying phones often look for screen protectors. Consider adding tempered glass protectors to your inventory.": "استناداً إلى أنماط الشراء، يبحث عملاء الهواتف غالباً عن واقيات الشاشة. فكر في إضافة واقيات زجاجية إلى مخزونك.",
    "Estimated additional revenue: ₦45,000/week": "إيراد إضافي متوقع: ₦45,000 أسبوعياً",
    "Add to inventory": "أضف إلى المخزون",
    "New Items Added": "تمت إضافة عناصر جديدة",
    "Ahmed added 20 units of iPhone 15 Pro Max Cases to inventory. Please confirm receipt.": "أضاف أحمد 20 قطعة من أغطية iPhone 15 Pro Max إلى المخزون. يرجى تأكيد الاستلام.",
    "Stock Discrepancy Detected": "تم اكتشاف تفاوت في المخزون",
    "Expected 12 Wireless Mouse units but system shows 8. Please verify physical count.": "المتوقع 12 وحدة من الفأرة اللاسلكية لكن النظام يظهر 8 فقط. يرجى التحقق من العدد الفعلي.",
    "Large Sale Recorded": "تم تسجيل عملية بيع كبيرة",
    "Ibrahim sold Samsung Galaxy A54 for ₦185,000. Transaction completed successfully.": "قام إبراهيم ببيع سامسونج جالاكسي A54 بسعر ₦185,000. اكتملت العملية بنجاح.",
    "Restock Recommendation": "توصية بإعادة التخزين",
    "USB-C Fast Chargers are selling fast. Consider restocking within 48 hours to avoid stockout.": "تُباع شواحن USB-C السريعة بسرعة. فكر في إعادة التخزين خلال 48 ساعة لتجنب نفاد المخزون.",
    "Low Stock Warning": "تحذير انخفاض المخزون",
    "iPhone 15 Pro Max Case has only 2 units left. Reorder to maintain stock levels.": "بقيت قطعتان فقط من غطاء iPhone 15 Pro Max. أعد الطلب للحفاظ على مستويات المخزون.",
    "Daily Sales Summary": "ملخص المبيعات اليومي",
    "Total sales for today: ₦892,400 with 47 items sold. Profit margin: 24.8%.": "إجمالي مبيعات اليوم: ₦892,400 مع بيع 47 عنصراً. هامش الربح: 24.8٪.",
    "Price Optimization": "تحسين السعر",
    "Wireless Earbuds Pro are trending. Consider a slight price increase to maximize profits.": "سماعات الأذن اللاسلكية برو رائجة. فكر في زيادة طفيفة في السعر لتعظيم الأرباح.",
  },
};
...
export function LanguageProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <LanguageContext.Provider
      value={{ language, isRTL, t, setLanguage, toggleLanguage, formatCurrency }}
    >
      {children}
    </LanguageContext.Provider>
  );
